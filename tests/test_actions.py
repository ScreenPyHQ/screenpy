...
class TestAttachTheFile:
    ...
    def test_divines_filename(self) -> None:
        ...
        filepath = Path("this/is/a/test") / filename
...
class TestSee:
    ...
    def test_log_passes(self, Tester: Actor, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_log_fails(self, Tester: Actor, caplog: pytest.LogCaptureFixture) -> None:
